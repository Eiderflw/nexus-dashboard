...
"[project]/nexus-dashboard/app/api/scraper/search-lives/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    try {
        ...
        if (!keyword) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$nexus$2d$dashboard$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Falta la palabra clave (keyword)'
            }, {
                status: 400
            });
        }
        const scriptPath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'scripts', 'search-lives.js');
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d4b7974e._.js.map